...
class positionPID:
    def __init__(self) -> None:
        ...
        self.pPOS[X] = 10 # 8 # 0.2
        self.iPOS[X] = 0#.000005
        self.dPOS[X] = 5#9#50#10 # 0.5

        self.pPOS[Y] = 20
        self.iPOS[Y] = 0#.000005
        self.dPOS[Y] = 5#9#50#40
    ...
    def output(self, pos_err : list, state : arucoState):
        ...
        result_Z = constrain(self.pPOS[Z] * pos_err[Z], -300, 300)
        ...
        self.last_result = [result_X, result_Y, 120]

        return (result_X, result_Y, 120)